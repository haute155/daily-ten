...
import { BookOpen, ChevronRight, LogOut, Tags, UserRound } from 'lucide-react';
    ...
    <div className="flex flex-col">
      ...
      <section className="px-4 mt-5">
        ...
        <div className="rounded-lg bg-white border border-neutral-200 divide-y divide-neutral-100">
          ...
          >
            <Tags size={16} className="text-neutral-500 flex-shrink-0" aria-hidden="true" />
            <span className="flex-1 text-sm text-neutral-800">카테고리 관리</span>
            {customCategories.length > 0 && (
              <span className="text-xs text-neutral-400">{customCategories.length}개 추가됨</span>
            )}
