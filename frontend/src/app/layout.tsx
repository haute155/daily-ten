    ...
    <html lang="ko">
      <body className={`${geist.variable} font-sans bg-white antialiased md:bg-neutral-200/70`}>
        ...
        <div className="md:min-h-dvh md:flex md:items-center md:justify-center md:p-6">
          <div className="w-full max-w-md mx-auto min-h-dvh bg-white relative md:min-h-0 md:h-[min(56rem,calc(100dvh-3rem))] md:rounded-lg md:border md:border-neutral-200 md:shadow-lg md:overflow-hidden">
            <main className="pb-20 md:h-full md:overflow-y-auto">{children}</main>
            <BottomNavClient />
          </div>
        </div>
